...
const required = [
  ...
  "public/skills/codexemailskill/SKILL.md",
  "public/.well-known/skills/codexemailskill/SKILL.md",
  "public/.well-known/agent-skills/codexemailskill/SKILL.md",
...
if (!markdown.includes("npx skills add codexemailskill")) throw new Error("Missing markdown install shortcut");
...
if (indexJson.skills?.[0]?.name !== "codexemailskill") throw new Error("Invalid well-known skills index");
